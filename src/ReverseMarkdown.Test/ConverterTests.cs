...
namespace ReverseMarkdown.Test
{
    public class ConverterTests
    {
        ...
        public void WhenListContainsMultipleParagraphs_ConvertToMarkdownAndIndentSiblings()
        {
            ...
            var expected =
                $"{Environment.NewLine}1. Item1{Environment.NewLine}{Environment.NewLine}    Item2{Environment.NewLine}2. Item3{Environment.NewLine}{Environment.NewLine}";
        ...
        [Fact]
        public void
            WhenListItemTextContainsLeadingAndTrailingSpacesAndTabs_TheConvertToMarkdownListItemWithSpacesAndTabsStripped()
        {
        ...
        [Fact]
        public void
            WhenThereIsEncompassingStrongOrBTag_ThenConvertToMarkdownDoubleAstericks_AnyStrongOrBTagsInsideAreIgnored()
        {
            const string html =
        ...
        {
            const string html =
                @"This text has ordered list.<ol><li><ul><li>InnerItem1</li><li>InnerItem2</li></ul></li><li>Item2</li></ol>";
            var expected =
                $"This text has ordered list.{Environment.NewLine}1. - InnerItem1{Environment.NewLine} - InnerItem2{Environment.NewLine}2. Item2{Environment.NewLine}{Environment.NewLine}";
            CheckConversion(html, expected);
        }
        ...
        public void WhenThereIsParagraphTag_ThenConvertToMarkdownDoubleLineBreakBeforeAndAfter()
        {
            ...
            var expected =
                $"This text has markup {Environment.NewLine}{Environment.NewLine}paragraph.{Environment.NewLine}{Environment.NewLine} Next line of text";
            CheckConversion(html, expected);
        }
        ...
        {
            const string html =
                @"This text has ordered list.<ul><li><ol><li>InnerItem1</li><li>InnerItem2</li></ol></li><li>Item2</li></ul>";
            var expected =
                $"This text has ordered list.{Environment.NewLine}- 1. InnerItem1{Environment.NewLine} 2. InnerItem2{Environment.NewLine}- Item2{Environment.NewLine}{Environment.NewLine}";
            CheckConversion(html, expected);
        }
    }
}