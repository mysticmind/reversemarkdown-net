...
namespace ReverseMarkdown.Test
{
    public class ConverterTests
    {
        ...
        {
            // https://github.com/mysticmind/reversemarkdown-net/issues/427 (default: opt-in, so no change)
            const string html =
                "<img src=\"data:image/png;base64,iVBORw0KGgo=\" data-src=\"https://example.com/image.webp\">";

            var converter = new Converter();

            Assert.Equal("![](data:image/png;base64,iVBORw0KGgo=)", converter.Convert(html));
        }
